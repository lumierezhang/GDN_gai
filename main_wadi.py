...
class Main():
    def __init__(self, train_config, env_config, debug=False):
        ...
        train_orig = pd.read_csv('./data/wadi/WADI_14days_new.csv', sep=',', index_col=0)
        test_orig = pd.read_csv('./data/wadi/WADI_attackdataLABLE.csv', sep=',',index_col=0)
        ...
        fc_edge_index = build_loc_net(fc_struc, list(train.columns), feature_map=feature_map)  #transform every edge to number max and remove self
